...
function loadClient() {
	gapi.client.setApiKey("AIzaSyCShoduqS-n2khomesmAwIyv2mHhTE0NHw"); //API Key
...
gapi.load("client:auth2", function () {
	gapi.auth2.init({
		client_id: "1019178509762-8v720oc1hgtjiv9j1d4do60smg8v2suf.apps.googleusercontent.com" //client ID
	});
});
